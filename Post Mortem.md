...
### Syfte och mål
### Arbetssätt
Under projektet har en iterativ arbetsprocess följts med sprintar på en vecka. Detta fungerar genom att man väljer ut de krav eller uppgifter som ska göras under veckan och uppskattar tiden det tar för att göra dessa. 
### Tekniker
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5MTc0NzUzNywtNTE3NTM0NzE0LC0xMj
