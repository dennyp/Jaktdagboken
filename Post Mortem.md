...
### Syfte och mål
### Arbetssätt
Under projektet har en iterativ arbetsprocess följts med sprintar på en vecka. Detta fungerar genom att man, till sin sprint backlog, väljer ut de krav eller uppgifter som ska göras under veckan och uppskattar tiden det tar för att göra dessa. En analys av föregående vecka görs också i sprinten.
### Tekniker
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwMzczMjYzNywtNTE3NTM0NzE0LC0xMj
